                ...
                (lengthLeft === 6 &&
                  ...
                  <div className="flex relative">
                    ...
                    >
                      ...
                      <Icon
                        style={{ color: leftDiv?.textColor || color }}
                        className={`z-10  ${
                          lengthLeft >= 3
                    ...
                    <div
                      className={`absolute ${
                        lengthLeft >= 3
                          ...
                          : "top-[30px] -right-7 md:right-[-60px]"
                      }`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
            ...
            return (
              ...
              >
                {(length === 1 || length === 2) && index === 0 && (
                  <svg
                    className={`absolute scale-y-[-1] ${
                      length >= 4
                        ...
                        : "w-8 md:w-14 lg:w-16 h-4 md:h-6 top-5 z-10 -left-8 md:-left-16 lg:left-[-75px]"
                    }`}
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 65 23"
                  >
                    <path
                      fill={singleDiv?.borderColor || color}
                  ...
                  <svg
                    className={`absolute scale-y-[-1] ${
                      length >= 4
                        ...
                        : "md:h-7 lg:h-[50px] w-8 md:w-14 lg:w-[65px] top-7 z-10 -left-8 md:-left-16 lg:left-[-80px]"
                    }`}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 59 30"
                  >
                  ...
                  <svg
                    className={`absolute scale-y-[-1] ${
                      length >= 4
                        ...
                        : "h-4 md:h-7 lg:h-[50px] w-8 md:w-14 lg:w-[65px] top-7 z-10 -left-8 md:-left-16 lg:left-[-80px]"
                    }`}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 59 30"
                  >
                  ...
                  <svg
                    className={`absolute  ${
                      length >= 4
                        ...
                        : "w-8 md:w-14 lg:w-[65px] h-4 md:h-[50px]  top-0 z-10 -left-8 md:-left-16 lg:left-[-75px]"
                    }`}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 59 30"
                  >
                  ...
                  <svg
                    className={`absolute ${
                      length >= 4
                        ...
                        : "w-8 md:w-14 lg:w-[65px] h-4 md:h-[50px] lg:h-[40px]  top-0 z-10 -left-8 md:-left-16 lg:left-[-78px]"
                    }`}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 59 30"
                  >
                ...
                >
                  <Icon
                    style={{ color: singleDiv?.textColor || color }}
