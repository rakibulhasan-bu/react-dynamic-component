          ...
          {rightSideComponents?.map((singleDiv, index) => {
            ...
            return (
              ...
              >
                ...
                {length >= 4 && index === 0 && (
                  <svg
                    className="absolute h-4 md:h-7 lg:h-[50px] w-8 md:w-14 lg:w-[65px] top-7 z-10 -left-8 md:-left-16 lg:left-[-80px] scale-y-[-1]"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 59 30"
                  >
                    <path
                ...
                {index === 3 && (
                  <svg
                    className="absolute  w-8 md:w-14 lg:w-[65px] h-4 md:h-[50px]  top-0 z-10 -left-8 md:-left-16 lg:left-[-75px] "
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 59 30"
                  >
                    <path
                ...
                {index >= 4 && (
                  <svg
                    className="absolute  w-8 md:w-14 lg:w-[65px] h-4 md:h-[50px] lg:h-[40px]  top-0 z-10 -left-8 md:-left-16 lg:left-[-78px] "
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 59 30"
                  >
                    <path
